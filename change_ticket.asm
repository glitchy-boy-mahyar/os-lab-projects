...
_change_ticket:     file format elf32-i386
...
int main(int argc, char* argv[]) {
  ...
  1f:	53                   	push   %ebx
  20:	53                   	push   %ebx
  21:	68 c8 07 00 00       	push   $0x7c8
  26:	6a 01                	push   $0x1
  28:	e8 33 04 00 00       	call   460 <printf>
        exit();
  ...
  4a:	50                   	push   %eax
  4b:	56                   	push   %esi
  4c:	e8 3a 03 00 00       	call   38b <change_ticket>
    exit();
