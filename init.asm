...
main(void)
{
  ...
  27:	0f 88 b3 00 00 00    	js     e0 <main+0xe0>
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  dup(0);  // stdout
  ...
  5b:	68 96 08 00 00       	push   $0x896
  60:	6a 01                	push   $0x1
  62:	e8 a9 04 00 00       	call   510 <printf>
    printf(1, "Group #6:\n1- Alireza Aghaei\n2- Alireza Salamat\n3- Mahyar Karimi\n");
  67:	58                   	pop    %eax
  68:	5a                   	pop    %edx
  69:	68 e4 08 00 00       	push   $0x8e4
  6e:	6a 01                	push   $0x1
  70:	e8 9b 04 00 00       	call   510 <printf>
    pid = fork();
  75:	e8 f1 02 00 00       	call   36b <fork>
    if(pid < 0){
  ...
  81:	78 26                	js     a9 <main+0xa9>
      printf(1, "init: fork failed\n");
      exit();
    }
    if(pid == 0){
  83:	74 37                	je     bc <main+0xbc>
  ...
  88:	e8 ee 02 00 00       	call   37b <wait>
  8d:	85 c0                	test   %eax,%eax
  8f:	78 c7                	js     58 <main+0x58>
  91:	39 c3                	cmp    %eax,%ebx
  93:	74 c3                	je     58 <main+0x58>
      printf(1, "zombie!\n");
  ...
  a9:	53                   	push   %ebx
  aa:	53                   	push   %ebx
  ab:	68 a9 08 00 00       	push   $0x8a9
  b0:	6a 01                	push   $0x1
  b2:	e8 59 04 00 00       	call   510 <printf>
      exit();
  b7:	e8 b7 02 00 00       	call   373 <exit>
      exec("sh", argv);
  bc:	50                   	push   %eax
  bd:	50                   	push   %eax
  be:	68 e0 0b 00 00       	push   $0xbe0
  c3:	68 bc 08 00 00       	push   $0x8bc
  c8:	e8 de 02 00 00       	call   3ab <exec>
      printf(1, "init: exec sh failed\n");
  cd:	5a                   	pop    %edx
  ce:	59                   	pop    %ecx
  cf:	68 bf 08 00 00       	push   $0x8bf
  d4:	6a 01                	push   $0x1
  d6:	e8 35 04 00 00       	call   510 <printf>
      exit();
  db:	e8 93 02 00 00       	call   373 <exit>
    mknod("console", 1, 1);
  e0:	50                   	push   %eax
  e1:	6a 01                	push   $0x1
  e3:	6a 01                	push   $0x1
  e5:	68 78 08 00 00       	push   $0x878
  ea:	e8 cc 02 00 00       	call   3bb <mknod>
    open("console", O_RDWR);
  ef:	58                   	pop    %eax
  f0:	5a                   	pop    %edx
  f1:	6a 02                	push   $0x2
  f3:	68 78 08 00 00       	push   $0x878
  f8:	e8 b6 02 00 00       	call   3b3 <open>
  fd:	83 c4 10             	add    $0x10,%esp
 100:	e9 28 ff ff ff       	jmp    2d <main+0x2d>
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	eb 1a                	jmp    6b0 <printf+0x1a0>
          s = "(null)";
 696:	bb 25 09 00 00       	mov    $0x925,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e5:	a1 e8 0b 00 00       	mov    0xbe8,%eax
{
 ...
 706:	73 10                	jae    718 <free+0x38>
{
 ...
 731:	5b                   	pop    %ebx
  freep = p;
 732:	a3 e8 0b 00 00       	mov    %eax,0xbe8
}
 737:	5e                   	pop    %esi
 738:	5f                   	pop    %edi
 739:	5d                   	pop    %ebp
 ...
 757:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 75a:	a3 e8 0b 00 00       	mov    %eax,0xbe8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 77d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 780:	8b 3d e8 0b 00 00    	mov    0xbe8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7c9:	8b 3d e8 0b 00 00    	mov    0xbe8,%edi
 ...
 7f2:	e8 e9 fe ff ff       	call   6e0 <free>
  return freep;
 7f7:	a1 e8 0b 00 00       	mov    0xbe8,%eax
 ...
 824:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 827:	a3 e8 0b 00 00       	mov    %eax,0xbe8
}
 ...
 847:	0b 00 00 
    base.s.size = 0;
 84a:	bf ec 0b 00 00       	mov    $0xbec,%edi
    base.s.ptr = freep = prevp = &base;
 84f:	c7 05 ec 0b 00 00 ec 	movl   $0xbec,0xbec
 856:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 859:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 85b:	c7 05 f0 0b 00 00 00 	movl   $0x0,0xbf0
 862:	00 00 00 
    if(p->s.size >= nunits){
