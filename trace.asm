...
int main() {
  ...
  1b:	68 f4 01 00 00       	push   $0x1f4
  20:	e8 0e 03 00 00       	call   333 <sleep>
        trace_syscalls(-1);
  25:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  2c:	e8 22 03 00 00       	call   353 <trace_syscalls>
  31:	83 c4 10             	add    $0x10,%esp
  34:	eb e2                	jmp    18 <main+0x18>
  36:	66 90                	xchg   %ax,%ax
  38:	66 90                	xchg   %ax,%ax
  3a:	66 90                	xchg   %ax,%ax
  3c:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
 ...
 615:	a1 5c 0a 00 00       	mov    0xa5c,%eax
{
...
malloc(uint nbytes)
{
 ...
 6ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6b0:	8b 3d 5c 0a 00 00    	mov    0xa5c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 722:	e8 e9 fe ff ff       	call   610 <free>
  return freep;
 727:	a1 5c 0a 00 00       	mov    0xa5c,%eax
