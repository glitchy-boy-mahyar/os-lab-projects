...
_change_BJF_all:     file format elf32-i386
...
int main(int argc, char* argv[]) {
  ...
  23:	51                   	push   %ecx
  24:	51                   	push   %ecx
  25:	68 28 08 00 00       	push   $0x828
  2a:	6a 01                	push   $0x1
  2c:	e8 8f 04 00 00       	call   4c0 <printf>
        exit();
  31:	e8 ed 02 00 00       	call   323 <exit>
    }

    char priority_ratio[64] = {0};
  36:	31 c0                	xor    %eax,%eax
  38:	8d bd 2c ff ff ff    	lea    -0xd4(%ebp),%edi
  3e:	b9 0f 00 00 00       	mov    $0xf,%ecx
  43:	c7 85 28 ff ff ff 00 	movl   $0x0,-0xd8(%ebp)
  4a:	00 00 00 
  4d:	f3 ab                	rep stos %eax,%es:(%edi)
    char arrival_ratio[64] = {0};
  4f:	8d bd 6c ff ff ff    	lea    -0x94(%ebp),%edi
  55:	b9 0f 00 00 00       	mov    $0xf,%ecx
    char executed_cycle_ratio[64] = {0};

    strcpy(priority_ratio, argv[1]);
    strcpy(arrival_ratio, argv[2]);
  5a:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
    char arrival_ratio[64] = {0};
  60:	f3 ab                	rep stos %eax,%es:(%edi)
    char executed_cycle_ratio[64] = {0};
  62:	8d 7d ac             	lea    -0x54(%ebp),%edi
  65:	b9 0f 00 00 00       	mov    $0xf,%ecx
    char arrival_ratio[64] = {0};
  6a:	c7 85 68 ff ff ff 00 	movl   $0x0,-0x98(%ebp)
  71:	00 00 00 
    char executed_cycle_ratio[64] = {0};
  74:	f3 ab                	rep stos %eax,%es:(%edi)
    strcpy(priority_ratio, argv[1]);
  76:	8d bd 28 ff ff ff    	lea    -0xd8(%ebp),%edi
  7c:	50                   	push   %eax
  7d:	50                   	push   %eax
  7e:	ff 73 04             	pushl  0x4(%ebx)
  81:	57                   	push   %edi
    char executed_cycle_ratio[64] = {0};
  82:	c7 45 a8 00 00 00 00 	movl   $0x0,-0x58(%ebp)
    strcpy(priority_ratio, argv[1]);
  89:	e8 32 00 00 00       	call   c0 <strcpy>
    strcpy(arrival_ratio, argv[2]);
  8e:	5a                   	pop    %edx
  8f:	59                   	pop    %ecx
  90:	ff 73 08             	pushl  0x8(%ebx)
  93:	56                   	push   %esi
  94:	e8 27 00 00 00       	call   c0 <strcpy>
    strcpy(executed_cycle_ratio, argv[3]);
  99:	58                   	pop    %eax
  9a:	5a                   	pop    %edx
  9b:	ff 73 0c             	pushl  0xc(%ebx)
  9e:	8d 5d a8             	lea    -0x58(%ebp),%ebx
  a1:	53                   	push   %ebx
  a2:	e8 19 00 00 00       	call   c0 <strcpy>
  ...
  ab:	56                   	push   %esi
  ac:	57                   	push   %edi
  ad:	e8 49 03 00 00       	call   3fb <change_BJF_parameters_all>
    exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	eb 1a                	jmp    660 <printf+0x1a0>
          s = "(null)";
 646:	bb 43 08 00 00       	mov    $0x843,%ebx
        while(*s != 0){
