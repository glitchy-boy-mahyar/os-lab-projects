...
_change_BJF_proc:     file format elf32-i386
...
int main(int argc, char* argv[]) {
  ...
  13:	53                   	push   %ebx
  14:	51                   	push   %ecx
  15:	81 ec c8 00 00 00    	sub    $0xc8,%esp
    if(argc != 5){
  1b:	83 39 05             	cmpl   $0x5,(%ecx)
int main(int argc, char* argv[]) {
  ...
  2c:	e8 9f 04 00 00       	call   4d0 <printf>
        exit();
  31:	e8 fd 02 00 00       	call   333 <exit>
    }
  ...
  3c:	8d bd 2c ff ff ff    	lea    -0xd4(%ebp),%edi
    int pid = atoi(argv[1]);
  42:	e8 79 02 00 00       	call   2c0 <atoi>
    char priority_ratio[64] = {0};
  47:	b9 0f 00 00 00       	mov    $0xf,%ecx
  4c:	c7 85 28 ff ff ff 00 	movl   $0x0,-0xd8(%ebp)
  53:	00 00 00 
    int pid = atoi(argv[1]);
  ...
  5a:	c7 45 a8 00 00 00 00 	movl   $0x0,-0x58(%ebp)
    char priority_ratio[64] = {0};
  61:	f3 ab                	rep stos %eax,%es:(%edi)
    char arrival_ratio[64] = {0};
  63:	8d bd 6c ff ff ff    	lea    -0x94(%ebp),%edi
  69:	b9 0f 00 00 00       	mov    $0xf,%ecx
  6e:	c7 85 68 ff ff ff 00 	movl   $0x0,-0x98(%ebp)
  75:	00 00 00 
  78:	f3 ab                	rep stos %eax,%es:(%edi)
    char executed_cycle_ratio[64] = {0};
  7a:	8d 7d ac             	lea    -0x54(%ebp),%edi
  7d:	b9 0f 00 00 00       	mov    $0xf,%ecx
  82:	f3 ab                	rep stos %eax,%es:(%edi)

    strcpy(priority_ratio, argv[2]);
  84:	8d bd 28 ff ff ff    	lea    -0xd8(%ebp),%edi
  8a:	58                   	pop    %eax
  8b:	5a                   	pop    %edx
  8c:	ff 73 08             	pushl  0x8(%ebx)
  8f:	57                   	push   %edi
  90:	e8 3b 00 00 00       	call   d0 <strcpy>
    strcpy(arrival_ratio, argv[3]);
  95:	8d 95 68 ff ff ff    	lea    -0x98(%ebp),%edx
  9b:	59                   	pop    %ecx
  9c:	58                   	pop    %eax
  9d:	ff 73 0c             	pushl  0xc(%ebx)
  a0:	52                   	push   %edx
  a1:	e8 2a 00 00 00       	call   d0 <strcpy>
    strcpy(executed_cycle_ratio, argv[4]);
  a6:	58                   	pop    %eax
  a7:	5a                   	pop    %edx
  a8:	ff 73 10             	pushl  0x10(%ebx)
  ab:	8d 5d a8             	lea    -0x58(%ebp),%ebx
  ae:	53                   	push   %ebx
  af:	e8 1c 00 00 00       	call   d0 <strcpy>

    change_BJF_parameters_individual(pid, priority_ratio, arrival_ratio, executed_cycle_ratio);
  b4:	8d 95 68 ff ff ff    	lea    -0x98(%ebp),%edx
  ba:	53                   	push   %ebx
  bb:	52                   	push   %edx
  bc:	57                   	push   %edi
  bd:	56                   	push   %esi
  be:	e8 40 03 00 00       	call   403 <change_BJF_parameters_individual>
    exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb 53 08 00 00       	mov    $0x853,%ebx
        while(*s != 0){
